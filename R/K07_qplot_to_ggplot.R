...
#' qplot is a deprecated package in the tidyverse for
#' "quick plots". Even though it's been deprecated, it
#' serves as a nice way to start learning ggplots.
#' When you run qplot(), you'll get a message that says
#' it's been deprecated. You can disregard that. The plot
...
# If you're ready, you can move on to koan 8: ggplot aesthetic mappings.
